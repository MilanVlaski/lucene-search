...
public class BaseLuceneIndex {
    ...
    public BaseLuceneIndex(String indexPath) throws IOException {
        this.currentDir = FSDirectory.open(Paths.get(indexPath));
        var reader = DirectoryReader.open(currentDir);
